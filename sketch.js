...
function preload() {
  spriteSheet = loadImage('assets/MeatBoy.png');
  spriteSheet2 = loadImage('assets/Robot.png');
  spriteSheet3 = loadImage('assets/SpelunkyGuy.png');
}
...
function setup() {
  ...
  walkingAnimation2 = new WalkingAnimation(spriteSheet2, 80, 80, 200, 200, 9);
